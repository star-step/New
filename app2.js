...
$(document).ready(function (){
    ...
    timerCount();
    //on clicking next display next question
...
function timerCount() {
    ...
    //if c != 0 and next button is clicked
...
function displayScore() {
    $(document).find(".quizContainer > .result").test("You scored " + correctAnswers + " out of " + questions.length);
